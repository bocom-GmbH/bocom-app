<template>
    <q-page class="">
        <!--  <file-component v-for="file in files" :id="file" :key="file" /> -->
        <q-btn
            class="q-ma-lg"
        ...
        const buttons = ref([
            {
                ...
                disable: store.doIHavePermissionFor(
                    '94ab3b81-b1dd-4d6f-a220-49cbe887ad24'
                ),
            },
            {
                label: 'Test2',
                ...
                disable: store.doIHavePermissionFor(
                    '602e03c4-0538-46d0-811f-8fb9d9d19441'
                ),
            },
            {
                label: 'Test3',
                ...
                disable: store.doIHavePermissionFor(
                    'f392cb3d-93d3-4c45-8d9f-78a725f0f451'
                ),
            },
        ]);
